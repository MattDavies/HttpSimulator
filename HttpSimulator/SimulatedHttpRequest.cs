...
namespace Subtext.TestLibrary
{
	...
	public class SimulatedHttpRequest : SimpleWorkerRequest
	{
		...
		public SimulatedHttpRequest(string applicationPath, string physicalAppPath, string physicalFilePath, string page, string query, TextWriter output, string host, int port, string verb, bool isSecure = false) : base(applicationPath, physicalAppPath, page, query, output)
		{
			if (host == null)
